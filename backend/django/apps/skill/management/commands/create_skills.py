...
from apps.skill.utils import SkillModel, parse_skills
...
class Command(BaseCommand):
    ...
    @staticmethod
    def _get_obsolete_values_list(model: Skill, actual_ids) -> list[tuple[int, str]]:
    ...
    def _log_results(self):
        ...
        obsolete_skill_ids = set(Skill.objects.values_list("id", flat=True)) - set(self.actual_skill_ids)
