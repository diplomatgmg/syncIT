...
(Важно! Навыки должны относиться к IT сфере. Навыки должны быть в общепринятом формате, например: React. Не использовать варианты, как React.js или react js. 123.
Ты должен достать ВСЕ ВОЗМОЖНЫЕ хард-скиллы из вакансии, В ТОМ ЧИСЛЕ ФРЕЙМВОКИ)
Формат работы: {work_formats}
(Важно! Если несколько форматов работы прислать их через запятую)
Описание: (Самая важная информация о вакансии. Прислать в структурированном виде. Используй табуляцию и "-" в качестве разделителя)
<END SYSTEM>
"""
